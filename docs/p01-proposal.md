...
- Does the sex of an individual affect their risk of dying to cardiovascular disease? We want to explore whether an individual's sex is
a possible risk factor because it determines many features about a person that are unchangable. We want to identify the risks a person may face and ensure that they are
given the proper information about how to take care of themselves especially because it concerns a disease that kills the most people in the United States.
